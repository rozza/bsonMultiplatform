 ...
 *
 * Consists of 12 bytes, divided as follows: <table border="1"> <caption>ObjectID layout</caption>
 * <tr>
 * <td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td><td>10</td><td>11</td>
 * </tr> * <tr> <td colspan="4">time</td><td colspan="5">random value</td><td colspan="3">inc</td>
 * </tr> * </table> *
 *
...
class BsonObjectId(
    ...
    companion object {
        ...
        operator fun invoke(byteArray: ByteArray): BsonObjectId {
            ...
            val randomValue2 = makeInt(byteArray[pos++], byteArray[pos++]).toShort()
            val counter = makeInt(byteArray[pos++], byteArray[pos++], byteArray[pos])
        ...
        private fun makeInt(vararg bytes: Byte): Int {
            ...
            return bytes
                .map { it.toInt() }
                .reduceIndexed { index, result, current -> result + current shl (8 * index) }
        }
    }
}
