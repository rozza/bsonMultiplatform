...
enum class BsonType(
    ...
    // TODO - confirm usage
    companion object {
        private val LOOKUP_TABLE = arrayOfNulls<BsonType>(MIN_KEY.value + 1)

        init {
            for (cur in BsonType.values()) {
                LOOKUP_TABLE[cur.value] = cur
            }
        }
         ...
         */
        fun findByValue(value: Int): BsonType? {
            return LOOKUP_TABLE[value and 0xFF]
        }
    }
}
